...
#[test]
fn test_slope_icon() -> Result<(), &'static str> {
    // curves
    ...
    // save figure
    let path = Path::new(OUT_DIR).join("integ_slope_icon.svg");
...
#[test]
fn test_slope_icon_logx() -> Result<(), &'static str> {
    ...
    // configure icons
    icon1.set_offset_v(0.0).set_log_x(true);
    icon2.set_offset_v(0.0).set_log_x(true).set_flipped(true);
    icon3.set_offset_v(0.0).set_log_x(true);
    icon4.set_offset_v(0.0).set_log_x(true).set_flipped(true);
    icon5.set_offset_v(0.0).set_log_x(true);
    icon6.set_offset_v(0.0).set_log_x(true).set_flipped(true);
    icon7.set_offset_v(0.0).set_log_x(true);
    icon8.set_offset_v(0.0).set_log_x(true).set_flipped(true);
    ...
    // save figure
    let path = Path::new(OUT_DIR).join("integ_slope_icon_logx.svg");
    plot.set_equal_axes(true).grid_and_labels("x", "y").save(&path)?;
...
#[test]
fn test_slope_icon_logy() -> Result<(), &'static str> {
    ...
    // configure icons
    icon1.set_offset_v(0.0).set_log_y(true);
    icon2.set_offset_v(0.0).set_log_y(true).set_flipped(true);
    icon3.set_offset_v(0.0).set_log_y(true);
    icon4.set_offset_v(0.0).set_log_y(true).set_flipped(true);
    icon5.set_offset_v(0.0).set_log_y(true);
    icon6.set_offset_v(0.0).set_log_y(true).set_flipped(true);
    icon7.set_offset_v(0.0).set_log_y(true);
    icon8.set_offset_v(0.0).set_log_y(true).set_flipped(true);
    ...
    // save figure
    let path = Path::new(OUT_DIR).join("integ_slope_icon_logy.svg");
    plot.set_equal_axes(true).grid_and_labels("x", "y").save(&path)?;
...
#[test]
fn test_slope_icon_loglog() -> Result<(), &'static str> {
    ...
    // configure icons
    icon1.set_offset_v(0.0).set_log_x(true).set_log_y(true);
    icon2
        .set_offset_v(0.0)
        .set_log_x(true)
        .set_log_y(true)
        .set_flipped(true);
    icon3.set_offset_v(0.0).set_log_x(true).set_log_y(true);
    icon4
        .set_offset_v(0.0)
        .set_log_x(true)
        .set_log_y(true)
        .set_flipped(true);
    icon5.set_offset_v(0.0).set_log_x(true).set_log_y(true);
    icon6
        .set_offset_v(0.0)
        .set_log_x(true)
        .set_log_y(true)
        .set_flipped(true);
    icon7.set_offset_v(0.0).set_log_x(true).set_log_y(true);
    icon8
        .set_offset_v(0.0)
        .set_log_x(true)
        .set_log_y(true)
    ...
    // save figure
    let path = Path::new(OUT_DIR).join("integ_slope_icon_loglog.svg");
    plot.set_equal_axes(true).grid_and_labels("x", "y").save(&path)?;
