...
DEFAULT_GENERATED = Path("/tmp/plotpy")
DEFAULT_REFERENCE = REPO_ROOT / "figures"
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    p.add_argument("--recursive", action=argparse.BooleanOptionalAction, default=True,
                   help="search the generated directory recursively (default: enabled); plotpy "
                        "writes figures into /tmp/plotpy/{doc_tests,integ_tests,unit_tests} and "
                        "files are matched to references in ./figures by basename")
